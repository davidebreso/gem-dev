...
#ifndef __PPDGBIND_H_INCLUDED__
...
#define XGRF_COLOUR 132	  /* [JCE] Set the colours (ViewMAX AES) */
#define XGRF_DTIMAGE 133  /* ViewMAX/3: Set desktop image */
						/* max sizes for arrays		*/
#define C_SIZE 5		/* was 4 for 2.0	*/
#define G_SIZE 15
#define I_SIZE 16
#define O_SIZE 7
#define AI_SIZE 3		/* was 2 for 3.0 	*/
...
#define PROP_GUI_SQUARE3D 1	/* 3D objects have square corners? */
#define PROP_GUI_FRAME3D  2	/* 3D frames? */
#define PROP_GUI_COMPAT   3	/* Atari compatibility mode (not implemented) */
#define PROP_GUI_MENU     4	/* Menubar options */

/* [JCE] extended application library */

#define XAPP_GETINFO 1020
#define XAP_GTYPE int_in[0]
#define XAP_GOUT1 int_out[1]
#define XAP_GOUT2 int_out[2]
#define XAP_GOUT3 int_out[3]
#define XAP_GOUT4 int_out[4]

/* [JCE] extended shell library */

#define XSHL_GETSHELL 1030
#define XSHL_SETSHELL 1031
#define XSHL_PROGNAME addr_in[0]

#define __PPDGBIND_H_INCLUDED__ 1

#endif  /* ndef __PPDGBIND_H_INCLUDED__ */
